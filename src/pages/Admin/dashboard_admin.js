    ...
    <div className="dashboard-container">
      ...
      <main className="main-content">
          ...
          <table>
            ...
            <tbody>
              <tr>
                ...
                <td>Client A</td>
                <td>John</td>
                <td><span className="dept-tag gst">GST</span></td>
                <td>Aug 10</td>
                <td><span className="status-tag pending">Overdue</span></td>
              </tr>
              <tr>
                <td>Redesign UI</td>
                <td>Client B</td>
                <td>Alice</td>
                <td><span className="dept-tag roc">ROC</span></td>
                <td>Aug 6</td>
                <td><span className="status-tag completed">Completed</span></td>
              </tr>
              <tr>
                <td>Test API</td>
                <td>Client C</td>
                ...
                <td>Aug 12</td>
                <td><span className="status-tag inprogress">In Progress</span></td>
              </tr>
            </tbody>
          </table>
        </section>
        ...
        <section className="departments">
          ...
          <div className="stats">
            <div className="stat-box" style={{ borderTopColor: '#FF6600' }}>
              GST
              <span>23</span>
            </div>
            <div className="stat-box" style={{ borderTopColor: '#0027FF' }}>
              Income Tax
              <span>18</span>
            </div>
            <div className="stat-box" style={{ borderTopColor: '#FF0057' }}>
              ROC
              <span>12</span>
            </div>
            <div className="stat-box" style={{ borderTopColor: '#8E44AD' }}>
              Certifications
              <span>9</span>
            </div>
            <div className="stat-box" style={{ borderTopColor: '#16A085' }}>
              Customer Details
              <span>15</span>
            </div>
          </div>
